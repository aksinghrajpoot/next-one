  ...
  return (
    <>
      ...
      <div className="main py-14">
        <div className="mycontainer grid grid-cols-1 md:grid-cols-2 order-1">
          ...
          <div className="col-start-1	my-auto">
            <h1 className="text-5xl font-bold text-gray-800">Make Your Business More Profitable</h1>
      ...
      <section className="features py-12 bg-orange-50">
        <div className="row">
          <h2 className="text-4xl font-medium text-center">Imagine Features</h2>
          <span className="block text-slate-800 text-center text-lg my-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga quos quaerat sapiente nam, id vero.
      ...
      <section className="feedback py-20">
        <div className="mycontainer grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="right py-6 md:p-12 items-center">
            <div className="title text-5xl font-bold text-[#3c3c3c]">
      ...
      <section className="feedback py-20">
        <div className="mycontainer grid grid-cols-1 md:grid-cols-2">
          <div className="left p-4 order-last">
