                ...
                <div className="mycontainer py-12">
                    ...
                    <form class="w-full max-w-lg mx-auto">
                        ...
                        <div class="md:flex md:items-center">
                            <div class="md:w-1/3">
                                <button class="justify-center w-full shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded " type="button">
                                    Send
                                </button>
                            </div>
